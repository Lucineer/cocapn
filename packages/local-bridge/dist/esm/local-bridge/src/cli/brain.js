...
// ---------------------------------------------------------------------------
export function buildBrainCommand() {
    const cmd = new Command("brain").description("Read and write the agent memory in the private repo");
    // ── fact sub-commands ────────────────────────────────────────────────────
    ...
    profile
        ...
        const manager = createProfileManager(resolve(opts.repo), resolve(opts.repo, "..", "public"), brain, config, sync);
    ...
    profile
        ...
        const manager = createProfileManager(resolve(opts.repo), publicRepo, brain, config, sync);
