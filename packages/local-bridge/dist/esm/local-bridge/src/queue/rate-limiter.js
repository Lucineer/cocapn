...
export class LLMRateLimiter {
     ...
     */
    async acquire(provider, tenantId, maxWaitMs = 30_000) {
     ...
     */
    getEffectiveRateLimit(provider) {
        const bucket = this.getOrCreateBucket(provider);
    ...
    getOrCreateTenantBucket(tenantKey, provider) {
    ...
    async waitForBucket(bucket, label, deadline) {
