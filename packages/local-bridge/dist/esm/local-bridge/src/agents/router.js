...
export class AgentRouter {
    ...
    spawner;
    cloudAdapters;
    constructor(config, registry, spawner, cloudAdapters) {
        this.config = config;
     ...
     */
    async resolveAndEnsureRunning(taskDescription) {
    ...
    matchingRules(description) {
        ...
        return this.config.rules.filter((rule) => lower.includes(rule.match.toLowerCase()));
    }
    pickByStrategy(rules) {
