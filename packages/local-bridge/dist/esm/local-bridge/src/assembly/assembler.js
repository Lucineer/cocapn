...
import { RepoDetector } from "./detector.js";
...
export class SelfAssembler {
    ...
    constructor(repoRoot) {
        ...
        this.matcher = new TemplateMatcher(join(repoRoot, "../../templates")); // Default templates dir
    }
    /**
     ...
     */
    generateConfig(profile, template, modules) {
        return {
            // Language detection
