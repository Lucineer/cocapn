 ...
 */
function getFleetAgent(ctx) {
    return ctx.fleetAgent;
}
// ─── FLEET_JOIN ───────────────────────────────────────────────────────────────
export async function handleFleetJoin(ws, _clientId, msg, ctx) {
...
// ─── FLEET_SUBMIT_TASK ────────────────────────────────────────────────────────
export async function handleFleetSubmitTask(ws, _clientId, msg, ctx) {
    const agent = getFleetAgent(ctx);
    if (!agent) {
        ctx.sender.typed(ws, {
...
// ─── FLEET_TASK_STATUS ───────────────────────────────────────────────────────
export async function handleFleetTaskStatus(ws, _clientId, msg, ctx) {
    const agent = getFleetAgent(ctx);
    if (!agent) {
        ctx.sender.typed(ws, {
...
// ─── FLEET_LIST_AGENTS ────────────────────────────────────────────────────────
export async function handleFleetListAgents(ws, _clientId, msg, ctx) {
    const agent = getFleetAgent(ctx);
    if (!agent) {
        ctx.sender.typed(ws, {
...
// ─── FLEET_HEARTBEAT ──────────────────────────────────────────────────────────
export async function handleFleetHeartbeat(ws, _clientId, msg, ctx) {
    const agent = getFleetAgent(ctx);
    if (!agent) {
        ctx.sender.typed(ws, {
