...
export class SlackWebhookHandler {
     ...
     */
    static verifySignature(body, signature, timestamp, signingSecret) {
     ...
     */
    static async sendResponse(responseUrl, message) {
        try {
     ...
     */
    static async sendEphemeral(responseUrl, text) {
     ...
     */
    static async sendInChannel(responseUrl, text) {
        await this.sendResponse(responseUrl, {
            text,
