...
// --- Template selection ---
async function selectTemplate(rl, prompt) {
...
// --- Directory structure ---
function createDirectoryStructure(cocapnDir) {
    const dirs = [
        "memory",
        "wiki",
        "tasks",
...
// --- soul.md ---
function createSoulMd(cocapnDir, answers, template) {
...
// --- config.yml ---
function createConfigYml(cocapnDir, answers, template) {
...
// --- Memory stores ---
function createMemoryStores(cocapnDir) {
...
// --- Wiki ---
function createWiki(cocapnDir, answers) {
...
// --- Secret storage ---
function storeSecret(envFile, provider, apiKey) {
