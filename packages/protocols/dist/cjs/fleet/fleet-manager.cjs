...
exports.fleetManager = exports.FleetManager = void 0;
const fleet_registry_js_1 = require("./fleet-registry.cjs");
const task_splitter_js_1 = require("./task-splitter.cjs");
...
class FleetManager {
    ...
    constructor(registry, splitter, config = {}) {
        this.registry = registry || new fleet_registry_js_1.FleetRegistry(config);
        this.splitter = splitter || task_splitter_js_1.taskSplitter;
...
// Singleton instance
// ---------------------------------------------------------------------------
exports.fleetManager = new FleetManager();
